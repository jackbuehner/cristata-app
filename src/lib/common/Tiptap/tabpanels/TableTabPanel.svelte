      ...
      <MenuFlyoutItem disabled={disabled || !editor?.can().deleteColumn()} on:click={deleteColumn}>
        <FluentIcon slot="icon">
          <svg height="100%" width="100%" viewBox="0,0,2048,2048" focusable="false">
            ...
            />
            <path type="path" class="OfficeIconColors_m223" d="M 768 1209 v -1107 h 410 v 1107 l -205 205 z" />
            <path
              type="path"
      ...
      <MenuFlyoutItem disabled={disabled || !editor?.can().deleteRow()} on:click={deleteRow}>
        <FluentIcon slot="icon">
          <svg height="100%" width="100%" viewBox="0,0,2048,2048" focusable="false">
            ...
            />
            <path type="path" class="OfficeIconColors_m223" d="M 1209 1178 h -1107 v -410 h 1107 l 205 205 z" />
            <path
              type="path"
              class="OfficeIconColors_m224"
