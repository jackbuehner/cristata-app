...
import { processSchemaDef as _processSchemaDef } from '$utils/processSchemaDef';
...
export const load = (async ({ parent, params, url }) => {
  ...
  const processSchemaDef = ((args?: {
    ...
    return _processSchemaDef({ schemaDef: schemaDef || collection.deconstructedSchema, ...opts });
