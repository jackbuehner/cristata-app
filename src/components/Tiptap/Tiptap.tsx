        ...
        <ToolbarActionRowContainer theme={theme}>
          <ToolbarRow isActive={activeTab === 'home'}>
            ...
            <Combobox
              ...
              `}
            >
              {editor.getMarkAttributes('textStyle').fontFamily || 'Georgia'}
            </Combobox>
            <Combobox
              onClick={showFontFamilyDropdown}
              color={'neutral'}
              ...
              `}
            >
              {editor.getMarkAttributes('textStyle').fontSize || '17px'}
            </Combobox>
            <ToolbarRowIconButton
