      ...
      return (
        <Wrapper theme={theme}>
          <Box theme={theme}>
            ...
            >
              <Button onClick={() => setStep('notice')}>Back</Button>
              <Button onClick={() => signInAction()}>Check again (reload page)</Button>
            </div>
          </Box>
        </Wrapper>
      );
          ...
          <Box theme={theme}>
            ...
            <div style={{ marginTop: 44, textAlign: 'center' }}>
              ...
              <p>
                ...
                the invitation. <br></br> <br></br> Click the <b>Finish</b> button once you have accepted the
                invitation.
              </p>
            </div>
            <div
            ...
            >
              <Button onClick={() => setStep('2fa_yes')}>Back</Button>
              <Button onClick={() => signInAction()}>Finish</Button>
            </div>
          </Box>
        </Wrapper>
      );
